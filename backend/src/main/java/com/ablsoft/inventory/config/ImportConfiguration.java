...
public class ImportConfiguration {
    ...
    @Bean
    public UploadFormatValidator uploadFormatValidator(ImportProperties properties) {
        return new UploadFormatValidator(properties);
    }

    @Bean
    public ProductImportService productImportService(
            ImportSnapshotStore snapshotStore, ImportProperties properties, Clock clock, Environment environment) {
